...
export declare const ALL_FEATURES: LicenseFeature[];
...
export interface StoredLicense {
    ...
    featureFlags: LicenseFeature[];
    localActivationAuditLog: AuditLogEntry[];
}
...
export interface IssuedLicenseRecord {
    ...
    activationKeyHash: string;
    status: 'ISSUED' | 'REISSUED' | 'REVOKED_LOCAL_RECORD';
    issuedAt: string;
    telegramUserId: string;
}
export interface RevokedLicenseRecord {
    licenseId: string;
    telegramUserId: string;
    deviceHash: string;
    revokedAt: string;
